...
EXILED est un framework de plugins à bas-niveau pour des serveurs d'SCP: Secret Laboratory. Il offre un système d'événements pour que les dévélopeurs  to hook in order to manipulate or change game code, or implement their own functions.
